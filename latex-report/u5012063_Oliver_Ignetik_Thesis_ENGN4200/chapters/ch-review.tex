...
and for parameter estimation the space alternating generalised expectation maximization algorithm
is employed.
...
known as a feed-forward neural network. Deep networks partially replace the need
...
optimization of neural networks is gradient descent and backpropogation.
