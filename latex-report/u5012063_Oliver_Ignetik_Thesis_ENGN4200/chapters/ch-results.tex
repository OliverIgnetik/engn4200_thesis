...
\begin{figure}
    ...
    \caption{Example of dictionary components obtained from NMF decomposition with a window size of 3000 samples, hop length of 512 and sampling frequency of 44.1 \si{\kilo\hertz}.}
...
\begin{figure}
    ...
    \caption{Example of activation components obtained from NMF decomposition with a window size of 3000 samples, hop length of 512 and sampling frequency of 44.1 \si{\kilo\hertz}.}
